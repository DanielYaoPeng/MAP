...
namespace MD.ApkMAP.AuthHelper.Policys
{
    /// <summary>
    /// 权限授权处理器
    /// </summary>
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, PermissionRequirement requirement)
        {
            ...
            requirement.Permissions = new List<PermissionItem>() { new PermissionItem { Role = Permissions.Admin } };
            ...
            if (httpContext != null)
            {
                ...
                if (defaultAuthenticate != null)
                {
                    ...
                    if (result?.Principal != null)
                    {
                        ...
                        if (!currentUserRoles.Contains(Permissions.Admin))//非管理员验证权限
                        {
                    ...
                    else if (!questUrl.Equals(requirement.LoginPath.ToLower(), StringComparison.Ordinal) && (!httpContext.Request.Method.Equals("POST") || !httpContext.Request.HasFormContentType))
                    {
                        //context.Fail();
                        //return;
